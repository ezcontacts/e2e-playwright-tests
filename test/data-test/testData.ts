...
export const FILTER_VALUE: Record<
  MatchFilterType | string,
  { endpoint: string; value: string | string[] }
> = {
  [MatchFilterType.PRICE_HIGHT_TO_LOW]: {
    endpoint: "/sort:price-high",
    value: "price-high",
  },
  [MatchFilterType.PRICE_LOW_TO_HIGHT]: {
    endpoint: "/sort:price-low",
    value: "price-low",
  },
  [MatchFilterType.BESTSELLING]: { endpoint: "", value: "bestselling" },
  [MatchFilterType.BEST_MATCH]: { endpoint: "", value: "-" },
  [MatchFilterType.POPULARITY]: {
    endpoint: "/sort:bestsellers/",
    value: "total_sold-desc",
  },
  [MatchFilterType.NEWEST]: {
    endpoint: "/sort:newest",
    value: ["date_created-desc", "newest"],
  },
  ...
  [MatchFilterType.PRICE_LOW]: {
    endpoint: "/sort:price-low/",
    value: "min_price-asc",
  },
  [MatchFilterType.PRICE_HIGH]: {
    endpoint: "/sort:price-high/",
    value: "min_price-desc",
  },
};

export const ACCOUNT_MENU_LINKS: Record<
  AccountMenu | string,
  { endpoint: string; title: string }
> = {
  [AccountMenu.AccountSettings]: {
    endpoint: "/account/main",
  ...
  [AccountMenu.RxInformation]: {
    endpoint: "/account/prescriptions",
    title: "PRESCRIPTION INFORMATION",
  },
  [AccountMenu.EzPoints]: { endpoint: "/account/ezpoints", title: "EZPOINTS" },
  [AccountMenu.RecentPrescriptions]: {
    endpoint: "/account/prescriptions/contact-lenses/recent",
    title: "",
  },
  [AccountMenu.WishList]: { endpoint: "/account/wishlist", title: "Wish List" },
  [AccountMenu.OnlineVisionTest]: {
    endpoint: "/account/online-vision-test-purchases",
    title: "ONLINE VISION TEST",
  },
  [AccountMenu.EzRefill]: {
    endpoint: "/account/subscription-history",
    title: "Subscription History",
  },
  [AccountMenu.StoreCredit]: {
    endpoint: "/account/store-credit",
    title: "Store Credit",
  },
};
...
export function getAccountMenuFromValue(
  ...
  const menuBtn = Object.values(AccountMenu).find((v) => v === value);
